...
Adobe [!DNL Commerce] 및 Adobe [!DNL Analytics] 통합의 주요 이점은 다음과 같습니다.

+ **포괄적인 고객 인사이트**: 통합은 고객 상호 작용에 대한 통합된 뷰를 제공하여 기업이 고객 행동, 환경 설정 및 구매 패턴에 대한 심층적인 통찰력을 얻을 수 있도록 합니다.
+ **향상된 마케팅 속성**: 마케터는 Adobe [!DNL Commerce] 및 Adobe [!DNL Analytics]의 데이터를 결합하여 판매 및 전환의 특성을 특정 마케팅 노력에 더 잘 부여하여 보다 정확한 ROI 측정 및 최적화를 가능하게 합니다.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <ul style="margin-top: 0;">
                    <li>스토어의 전반적인 성능을 전체적으로 파악하려는 경우. 특히, [!DNL Commerce] 인텔리전스에 대한 Adobe [!DNL Analytics] 통합은 판매자가 Adobe [!DNL Commerce] 및 Adobe [!DNL Analytics] 데이터 세트의 결합을 시작할 수 있는 기능을 제공합니다.</li>
                </ul>
            </td>
            <td>
                <ul style="margin-top: 0;">
