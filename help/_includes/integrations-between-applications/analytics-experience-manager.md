...
+ **정확한 세분화**: 캠페인의 개인화된 대상 세그먼트를 위해 Adobe [!DNL Analytics] 및 Audience Manager을 병합합니다.
+ **포괄적인 고객** 프로필: 상호 작용 및 동작을 통합적으로 이해하기 위해 데이터 소스를 통합합니다.
+ **광고 타깃팅 최적화**: Adobe [!DNL Analytics] 및 Audience Manager의 데이터 기반 타깃팅을 통해 광고 효과를 향상시킵니다.
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
              <ul style="margin-top: 0;">
                <li>Adobe [!DNL Analytics]에서 디지털 양식 분석 데이터를 보고하고 향후 다른 Experience Cloud 애플리케이션과 통합할 수 있도록 직접 배치합니다.</li>
              </ul>
            </td>
            <td>
                <ul style="margin-top: 0;">
