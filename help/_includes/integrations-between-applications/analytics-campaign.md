...
Adobe [!DNL Analytics]과(와) Adobe [!DNL Campaign]의 통합을 통해 원활한 데이터 공유 및 이메일 추적을 가능하게 하며 다음과 같은 이점을 제공합니다.

+ **KPI 데이터를 공유**&#x200B;하여 Adobe [!DNL Campaign]에서 Adobe [!DNL Analytics]에 연결합니다.
