---
title: 다른 Adobe 애플리케이션과 Adobe [!DNL Experience Platform] 통합
...
# 다른 Adobe 애플리케이션과 [!DNL Platform] 경험 통합

Adobe Experience [!DNL Platform]은(는) 고객 경험을 주도하는 완벽한 솔루션을 구축하고 관리하기 위해 시장에서 가장 강력하고 유연하며 개방적인 시스템입니다. 다음을 포함하여 [!DNL Platform] 경험 위에 많은 새로운 Adobe 응용 프로그램이 빌드되었습니다.
...
* [Audience Manager 사용](../rtcdp/rtcdp-aam.md)
