---
title: Adobe [!DNL Analytics] 및 고객 여정 [!DNL Analytics] 을 Experience [!DNL Platform] Edge 자습서와 통합
description: AEP Web SDK, AEP Mobile SDK 또는 Edge Network Server API를 사용하여 Adobe을 통합 [!DNL Analytics] 고객 여정과 통합 [!DNL Analytics] 하는 방법에 대해 알아봅니다.
