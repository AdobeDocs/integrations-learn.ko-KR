  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        AEM Assets 및 Adobe [!DNL Analytics].</td>
      <td>
        <ul style="margin-top: 0;">
          <li>자산 성과 추적 및 분석</li>
          <li>사용자 참여 분석</li>
    ...
    <tr>
      <td>
        부서 내 에셋 생성 조정 및 측정
        AEM Assets Essentials 및 Workfront 통합.</td>
      <td>
        <ul style="margin-top: 0;">
          <li>부서별 자산 관리 간소화</li>
    ...
    <tr>
      ...
      <td>
        ...
        Adobe [!DNL Target]과(와) 함께 AEM Headless를 활용합니다.</td>
      <td>
        <ul style="margin-top: 0;">
    ...
    <tr>
      <td>
        ...
        개인화를 위해 Adobe [!DNL Target]을(를) 사용합니다.</td>
      <td>
        <ul style="margin-top: 0;">
          <li>AEM 웹 사이트 개인화</li>
    ...
    <tr>
      ...
      <td>
        ...
        웹, 모바일 및 기타 디지털 채널에서 메시지를 개인화하려면</td>
      <td>
        <ul style="margin-top: 0;">
