...
+ 솔루션 카테고리{#solution-categories}
   ...
   + [컨텐츠 supply chain](./solution-categories/content-supply-chain.md)
...
+ 튜토리얼{#tutorials}
   ...
   + Experience Manager 및 Target{#experience-manager-target}
      ...
      + [라이브 데모](https://experienceleague.adobe.com/ko/docs/experience-manager-learn/cloud-service/personalization/live-demo)
